          ...
          <TouchableWithoutFeedback>
            ...
            <View className="bg-surface rounded-3xl p-6 w-full max-w-md max-h-[80%]">
              ...
              <ScrollView className="mb-4">
                {order?.orderItems.map((item, index) => {
                  ...
                  return (
                    <View
                      key={item._id}
                      className={`bg-background-light rounded-2xl p-4 ${index < order.orderItems.length - 1 ? "mb-3" : ""}`}
                    >
              ...
              <View className="gap-3">
                ...
                <TouchableOpacity
                  className="bg-surface-ligter rounded-2xl py-4 items-center border border-background-ligter"
                  activeOpacity={0.7}
                  onPress={onClose}
                  disabled={isSubmitting}
                >
